...
def process_file(ftuple, create_windows, convert_fn, lengths):
    ...
    for matrix in matrices:
        ...
        a = matrix[:src_len, ...].reshape((src_len, -1))
        # print(f'shape of source matrix after reshape:{a.shape}')
        # print(f'tgt_len:{tgt_len}')
        b = matrix[src_len : src_len + tgt_len, ...].reshape((tgt_len, -1))
        # print(f'shape of target matrix after reshape:{b.shape}')
        i += 1
