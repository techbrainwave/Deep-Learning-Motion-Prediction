...
def prepare_model(
    input_dim, hidden_dim, ninp, device, num_layers=1, num_heads=8, src_length=120, architecture="seq2seq"
):
    if architecture == "rnn":
    ...
    if architecture == "seq2seq":
        ...
        model = transformer.TransformerModel(
            input_dim, ninp, num_heads, hidden_dim, num_layers,
        )
